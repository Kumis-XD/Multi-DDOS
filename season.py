...
princp=[]
try:
	prox= requests.get('https://api.openproxy.space/premium/plain/protocols?checksLess=10000&excludeCountries=AE,AF,AL,AM,AR,AT,AU,AZ,BA,BD,BE,BF,BG,BI,BJ,BO,BR,BT,BW,BY,CA,CD,CG,CH,CL,CM,CN,CO,CR,CY,CZ,DE,DK,DO,EC,EG,ES,ET,FI,FR,GB,GE,GH,GM,GN,GQ,GR,GT,HK,HN,HR,HT,HU,ID,IE,IL,IN,IQ,IR,IS,IT,JM,JP,KE,KG,KH,KR,KZ,LA,LB,LS,LT,LU,LV,LY,MD,ME,MG,MK,MM,MN,MO,MT,MU,MW,MX,MY,MZ,NA,NG,NI,NL,NO,NP,NZ,PA,PE,PH,PK,PL,PR,PS,PT,PY,QA,RO,RS,RU,RW,SA,SD,SE,SI,SK,SN,SO,SS,SV,SY,TH,TJ,TL,TN,TR,TT,TW,TZ,UA,UG,US,UY,UZ,VE,VN,XK,YE,YT,ZA,ZM,ZW,ZZ&ports=3148&protocols=2,3&quality=100&smart=1&status=3&streak=100&timeoutAverage=6000&uptime=100').text
...
def menu(my_name,my_id):
	...
	gh = 'github.com/KUMIS-XD'
	print(f'Selamat Datang {asu}%s{N}'%(my_name))
...
#-------------------[ BAGIAN-WORDLIST ]------------#
def passwrd():
	print(f'>>>>> {m}•{k}•{h}•{x} orang sabar disayang Allah SWT {m}•{k}•{h}•{x} <<<<< ')
	print('')
