...
princp=[]
try:
	prox= requests.get('https://api.openproxy.space/premium/plain/protocols?amount=561&apiKey=KUMISXD24&checksLess=2631&excludeCountries=SG,US&filename=kumis&ports=22&protocols=2&quality=66&stableAverage=0,1&status=1&streak=35&timeoutAverage=8000&uptime=50').text
